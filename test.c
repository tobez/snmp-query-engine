...
int
test_encode_string_oid(int *test, const char *oid, const char *res, int len)
{
...
main(void)
{
	int success = 0;
	int n_tests = 0;
	success += test_encode_string_oid(&n_tests, "1.3.6.1.2.1.2.2.1.2.1001", "\x06\x0b\x2b\x06\x01\x02\x01\x02\x02\x01\x02\x87\x69", 13);
	success += test_encode_string_oid(&n_tests, ".1.3.6.1.2.1.2.2.1.2.25", "\x06\x0a\x2b\x06\x01\x02\x01\x02\x02\x01\x02\x19", 12);
