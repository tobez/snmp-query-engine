...
STDOBJ=event_loop.o carp.o client_input.o client_listen.o opts.o util.o destination.o request_queue.o
...
request_queue.o: request_queue.c sqe.h
	cc -c $(CFLAGS) -o request_queue.o request_queue.c
