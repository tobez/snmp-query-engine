...
all: snmp-query-engine t/test_ber test_msgpack t/test_v3 t/test_sid_info
...
clean:
	rm -f *.o snmp-query-engine t/test_ber test_msgpack t/test_v3 t/test_sid_info *.core core
	rm -rf t/*.dSYM *.dSYM
...
t/test_v3: t/test_v3.c t/tap.h $(STDOBJ)
	$(CC) $(CFLAGS) -o t/test_v3 t/test_v3.c $(STDLINK)
